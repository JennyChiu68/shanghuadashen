...
如果出现大量 `HTTP Error 403: Forbidden`，通常是因为网络环境阻止访问维基百科，或需要更明确的 User-Agent。可以尝试：

```bash
python3 scripts/fetch_flower_images.py --user-agent "shanghuadashen-bot/1.0 (contact: you@example.com)"
```
